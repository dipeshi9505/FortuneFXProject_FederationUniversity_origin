<div id="left_sidebar" class="sidebar_grid">
    <div id="calendar" class="sidebar_cont">
      ...
      <hr/>
      <iframe src="http://ec.forexprostools.com/?ecoDayBackground=%23dedede&defaultFont=%233d3d3d&columns=exc_flags,exc_currency,exc_importance,exc_actual,exc_forecast,exc_previous&category=_employment,_economicActivity,_inflation,_credit,_centralBanks,_confidenceIndex,_balance,_Bonds&importance=1,2,3&features=datepicker,timezone,filters&countries=25,32,6,37,72,22,17,39,14,48,10,35,42,7,43,60,45,36,110,11,26,12,46,4,5&calType=day&timeZone=31&lang=1" style="width:100%;height:900px;border:none;padding:0px 0px 1px 12px;border:1px solid #eaeaea;" id="cal_if">
      </iframe>
      </div>
    <!--end calendar-->
</div>
